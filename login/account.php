...
<body>
    <header class="header">
        ...
        <a class="logo" href="index.php" style="margin-left:-150px">Quantum Mobile</a>
    ...
    <div class="main">
        <div class="content">
            <div class="footer-links">
                <h1>Welcome to your account <font style="color:#74a9ff"><?php echo isset($_SESSION['customerId']) ? $customerUName : 'Login'; ?></font> </h1><br>
            </div>    
